        ...
        btnChoose.setOnClickListener {
            ...
            if(checkedRadioButtonId!=-1){
                ...
                when(checkedRadioButtonId){
                    R.id.rb_saf -> coach = rbSaf.text.toString()
                    R.id.rb_mou -> coach = rbMou.text.toString()
                    R.id.rb_lvg -> coach = rbLvg.text.toString()
                    R.id.rb_moyes -> coach = rbMoyes.text.toString()
                }
