package com.rafli.alarmmanager.receiverClass
...
import com.rafli.alarmmanager.MainActivity
import com.rafli.alarmmanager.R
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object{
        const val  TYPE_ONE_TIME= "OneTimeAlaram"
        const val TYPE_REPEATING="RepeatingAlarm"
        const val EXTRA_MESSAGE="pesan"
        const val EXTRA_TYPE="tipe"

        private const val DATE_FORMAT="yyyy-mm-dd"
        private const val TIME_FORMAT="HH:mm"

        //2 id untuk 2 macam alarm. onetime dan repeating.
    ...
    fun cancelAlarm(context:Context,type:String){
        val alarmManager= context.getSystemService(Context.ALARM_SERVICE) as AlarmManager
        val intent = Intent(context,AlarmReceiver::class.java)
        val requestCode=if(type.equals(TYPE_ONE_TIME,ignoreCase = false)) ID_ONETIME else ID_REPEATING
    ...
    fun setOneTimeAlarm(context: Context,type:String,date:String,time:String,
    message: String?){
    ...
    private fun showAlarmNotification(context: Context,title: String,message: String?,
        ...
        val disintent=PendingIntent.getActivity(context,0,
            Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/search?q=$message")),0)
